...
const projects = [
  ...
  },
  {
    ...
    tech: ["React", "Tailwind CSS","Spring Boot", "MySQL","mui icon"],
    link: "#",
  },
  {
  ...
  {
    title: "food ordering system Website",
    description: "Personal developer portfolio website.",
    tech: ["React", "Tailwind CSS"],
    link: "#",
  },
...
function Projects() {
  return (
    <div id="projects" className="min-h-screen bg-slate-950 text-white md:px-6 px-2 py-10 space-y-10 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        {projects.map((project, index) => (
          <div
            key={index}
            className="bg-slate-900 md:p-6 p-2 rounded-xl shadow-lg hover:scale-105 transition"
          >
            ...
            <div className="relative w-[220px] sm:w-[250px] md:w-[420px] mx-auto">
